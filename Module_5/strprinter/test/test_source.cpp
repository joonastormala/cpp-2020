...
PREREQ_TEST(Printers, Add_and_indexing, 1, 1) {
    {
        ...
        gcheck::SequenceArgument inputs_not_reserved0({std::vector<std::string>({"mumbo", "a name", "second name", "something", "John Cena"}),std::vector<std::string>({"mumbo", "a name", "second name", "something", "John Cena"}),std::vector<std::string>({"mumbo", "a name", "second name", "something", "John Cena"})});
        gcheck::SequenceArgument inputs_not_reserved1({std::vector<std::string>({"mumbo", "a name", "second name", "something", "John Cena"}),std::vector<std::string>({"mumbo", "a name", "second name", "something", "John Cena"}),std::vector<std::string>({"mumbo", "a name", "second name", "something", "John Cena"})});
