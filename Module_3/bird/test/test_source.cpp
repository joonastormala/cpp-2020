...
PREREQ_TEST(Bird, constructor, 1, 0) {
    {
        std::vector correct_not_reserved = {"Orly","Esko","Seppo","Alfred","Seppo"};
        gcheck::SequenceArgument inputs_not_reserved0({std::string("Orly"),std::string("Esko"),std::string("Seppo"),std::string("Alfred"),std::string("Seppo")});
        TestCase(5,correct_not_reserved,TConstructDuck,inputs_not_reserved0);
    };
    {
        std::vector correct_not_reserved = {"Seppo","Seppo","Orly","Alfred","Albert"};
        gcheck::SequenceArgument inputs_not_reserved0({std::string("Seppo"),std::string("Seppo"),std::string("Orly"),std::string("Alfred"),std::string("Albert")});
...
PREREQ_TEST(Birds, Speak, 2, 0) {
    {
        std::vector correct_not_reserved = {"Alfred: QUACK\n","Alfred: QUACK\n","Alfred: QUACK\n","Orly: QUACK\n","Albert: QUACK\n"};
        gcheck::SequenceArgument inputs_not_reserved0({std::string("Alfred"),std::string("Alfred"),std::string("Alfred"),std::string("Orly"),std::string("Albert")});
        TestCase(5,correct_not_reserved,TSpeakDuck,inputs_not_reserved0);
    };
    {
        std::vector correct_not_reserved = {"Orly: WHUU\n","Esko: WHUU\n","Orly: WHUU\n","Esko: WHUU\n","Esko: WHUU\n"};
        gcheck::SequenceArgument inputs_not_reserved0({std::string("Orly"),std::string("Esko"),std::string("Orly"),std::string("Esko"),std::string("Esko")});
